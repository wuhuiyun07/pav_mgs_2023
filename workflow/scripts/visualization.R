...
read_data <- function() {
  ...
  for (i in 1:length(vs2_files)) {
    ...
    all_results[[i]] <- screen_result
  }
  
  return(all_results)
}

## trail #5, save each iteration file
...
# read_data("results/vs2/24_4_S19.vs2.final-viral-score.tsv","results/checkV/24_4_S19.checkv.quality_summary.tsv","resu
    # lts/diamond/24_4_S19.tsv.gz")
...
read_data <- function(vs2_path, checkV_path, diamond_path) {
